#!/bin/bash
echo "=== Intervue Coder - By Suryanshu Nabheet ==="
echo
...
mkdir -p ~/Library/Application\ Support/intervue-coder/temp
mkdir -p ~/Library/Application\ Support/intervue-coder/cache
mkdir -p ~/Library/Application\ Support/intervue-coder/screenshots
mkdir -p ~/Library/Application\ Support/intervue-coder/extra_screenshots
