...
mkdir "%APPDATA%\intervue-coder\temp" 2>nul
mkdir "%APPDATA%\intervue-coder\cache" 2>nul
mkdir "%APPDATA%\intervue-coder\screenshots" 2>nul
mkdir "%APPDATA%\intervue-coder\extra_screenshots" 2>nul
